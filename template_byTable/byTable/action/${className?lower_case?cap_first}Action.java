...
import ${basepackage}.busanalysis.service.${className}Service;
...
public class ${className?lower_case?cap_first}Action extends BaseActionSupport<${className}> {
    ...
    public String edit(){
        ...
        if(StringUtils.isNotEmpty(id)){
            ${className} obj = ${className}Service.selectByPK(Integer.parseInt(id));
    ...
    public void deleteAjax() {
        // FIXME 仅供参考
        String id = getRequest().getParameter("id");
        int result = ${className}Service.delete(Integer.parseInt(id));
